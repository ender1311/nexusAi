...
| [bandit-engine.md](./bandit-engine.md) | Thompson Sampling, Epsilon-Greedy & LinUCB algorithms, reward calculation, arm update flow |
...
| [persona-discovery.md](./persona-discovery.md) | K-Means++ clustering, 10-dim feature vector, cosine similarity, engagement buckets |
...
4. **`/api/personas/discover`** — clusters users into personas via K-Means++ on 10-dim feature vectors
