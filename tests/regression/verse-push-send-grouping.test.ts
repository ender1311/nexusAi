...
const meta = new Map<string, VariantMeta>([
  ["v-ref", { channel: "push", body: VERSE_PUSH_SENTINEL, title: "[verse:reference]", deeplink: null, brazeCampaignId: null, brazeVariantId: null, givingHandleStrategy: null, cta: null, iconImageUrl: null }],
]);
