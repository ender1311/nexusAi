...
const CATEGORIES: CategoryDef[] = [
  ...
  // ── Plans ──────────────────────────────────────────────────────────────────
  {
    ...
    variants: [
      ...
      { subcategory: "my-plans", name: "Pause and Celebrate (Personalized)", title: '{{${first_name} | default: "friend"}}, pause and celebrate!', body: "You took another step towards reading the whole Bible today.", deeplink: "https://www.bible.com/my-plans", cta: "Continue My Plans", actionFeatures: { tone: "milestone", hasPersonalization: true, ctaType: "deeplink", messageLengthBucket: "short", sourceFile: "2026-01-bioy-workflow-PUSH-19.json" } },
