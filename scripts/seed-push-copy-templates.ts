...
const CATEGORIES: CategoryDef[] = [
  // ── Reader ─────────────────────────────────────────────────────────────────
  {
    ...
    variants: [
      ...
      },
      {
        ...
        title: '{{${first_name} | default: ""}}, you can do this!',
        body: "See what God's Word will say to you today ➡️",
        deeplink: "youversion://bible",
        cta: "Open Bible App",
      ...
      { subcategory: "open-bible", name: "What Did God Teach You (Reward)", title: "What did God teach you?", body: "You spent time with God today!", deeplink: "https://www.bible.com/today", cta: "Open Bible", actionFeatures: { tone: "question", hasPersonalization: false, ctaType: "deeplink", messageLengthBucket: "short", sourceFile: "2026-01-daily-reward-PUSH-1-en.json" } },
      ...
      { subcategory: "open-bible", name: "What Did God Show You (Reward)", title: "What did God show you?", body: "You spent time in God's Word today. Keep going strong!", deeplink: "https://www.bible.com/today", cta: "Open Bible", actionFeatures: { tone: "question", hasPersonalization: false, ctaType: "deeplink", messageLengthBucket: "short", sourceFile: "2026-01-daily-reward-PUSH-4-en.json" } },
      ...
      { subcategory: "open-bible", name: "Cheering You On (Personalized Reward)", title: '{{${first_name} | default: ""}}, we\'re cheering you on!', body: "Spending time in God's Word? That's a win worth celebrating.", deeplink: "https://www.bible.com/today", cta: "Open Bible", actionFeatures: { tone: "milestone", hasPersonalization: true, ctaType: "deeplink", messageLengthBucket: "short", sourceFile: "2026-01-daily-reward-PUSH-5-en.json" } },
      ...
      { subcategory: "open-bible", name: "Keep It Up (Personalized Reward)", title: '{{${first_name} | default: ""}}, keep it up!', body: "You're building your Bible habit this month. 🥳", deeplink: "https://www.bible.com/today", cta: "Open Bible", actionFeatures: { tone: "milestone", hasPersonalization: true, ctaType: "deeplink", messageLengthBucket: "short", sourceFile: "2026-01-daily-reward-PUSH-9-en.json" } },
      { subcategory: "open-bible", name: "Let's Reflect (Personalized Reward)", title: '{{${first_name} | default: ""}}, let\'s reflect!', body: "What is God's Word teaching you?", deeplink: "https://www.bible.com/today", cta: "Open Bible", actionFeatures: { tone: "question", hasPersonalization: true, ctaType: "deeplink", messageLengthBucket: "short", sourceFile: "2026-01-daily-reward-PUSH-10-en.json" } },
      ...
      { subcategory: "open-bible", name: "What Will You Learn (Personalized Remind)", title: '{{${first_name} | default: ""}}, what will you learn?', body: "What will God teach you through His Word?", deeplink: "https://www.bible.com/today", cta: "Open Bible", actionFeatures: { tone: "question", hasPersonalization: true, ctaType: "deeplink", messageLengthBucket: "short", sourceFile: "2026-01-daily-remind-PUSH-2-en.json" } },
      { subcategory: "open-bible", name: "One Day at a Time (Personalized Remind)", title: 'One day at a time, {{${first_name} | default: ""}}…', body: "…You can build your Bible habit! Reflect on God's Word ➡️", deeplink: "https://www.bible.com/today", cta: "Open Bible", actionFeatures: { tone: "empathy", hasPersonalization: true, ctaType: "deeplink", messageLengthBucket: "medium", sourceFile: "2026-01-daily-remind-PUSH-4-en.json" } },
      { subcategory: "open-bible", name: "Keep Going (Personalized Remind)", title: '{{${first_name} | default: ""}}, keep going!', body: "Build your Bible habit today.", deeplink: "https://www.bible.com/today", cta: "Open Bible", actionFeatures: { tone: "urgency", hasPersonalization: true, ctaType: "deeplink", messageLengthBucket: "short", sourceFile: "2026-01-daily-remind-PUSH-5-en.json" } },
      ...
      { subcategory: "open-bible", name: "Prayer Can Change Lives (Remind)", title: "🙏 Prayer can change lives.", body: "Experience nighttime prayer before you end your day.", deeplink: "https://www.bible.com/today", cta: "Open Bible", actionFeatures: { tone: "empathy", hasPersonalization: false, ctaType: "deeplink", messageLengthBucket: "short", sourceFile: "2026-01-daily-remind-PUSH-12-en.json" } },
  ...
  // ── Plans ──────────────────────────────────────────────────────────────────
  {
    ...
    variants: [
      ...
      { subcategory: "find-plans", name: "How Are You Today (Personalized Remind)", title: '{{${first_name} | default: ""}}, how are you today?', body: "There's a Plan for whatever you're feeling. Find one today!", deeplink: "https://www.bible.com/reading-plans", cta: "Find a Plan", actionFeatures: { tone: "empathy", hasPersonalization: true, ctaType: "deeplink", messageLengthBucket: "short", sourceFile: "2026-01-daily-remind-PUSH-9-en.json" } },
      ...
      },
      {
        ...
        title: '{{${first_name} | default: ""}}, keep going!',
      ...
      },
      {
        ...
        title: '{{${first_name} | default: ""}}, what did you learn today?',
      ...
      { subcategory: "my-plans", name: "High Five (Personalized)", title: '{{${first_name} | default: ""}}, high five! 🫸🫷', body: "Way to go completing another day of your whole Bible Plan.", deeplink: "https://www.bible.com/my-plans", cta: "Continue My Plans", actionFeatures: { tone: "milestone", hasPersonalization: true, ctaType: "deeplink", messageLengthBucket: "short", sourceFile: "2026-01-bioy-workflow-PUSH-11.json" } },
      { subcategory: "my-plans", name: "You're Amazing (Personalized)", title: '{{${first_name} | default: ""}}, you\'re amazing!', body: "You completed another day of your whole Bible Plan.", deeplink: "https://www.bible.com/my-plans", cta: "Continue My Plans", actionFeatures: { tone: "milestone", hasPersonalization: true, ctaType: "deeplink", messageLengthBucket: "short", sourceFile: "2026-01-bioy-workflow-PUSH-12.json" } },
      { subcategory: "my-plans", name: "🎉 Celebrations (Personalized)", title: '{{${first_name} | default: ""}}, 🎉🎉🎉', body: "Way to go completing another day of your whole Bible Plan!", deeplink: "https://www.bible.com/my-plans", cta: "Continue My Plans", actionFeatures: { tone: "milestone", hasPersonalization: true, ctaType: "deeplink", messageLengthBucket: "short", sourceFile: "2026-01-bioy-workflow-PUSH-13.json" } },
      { subcategory: "my-plans", name: "Star for You (Personalized)", title: '{{${first_name} | default: ""}}, ⭐ for you', body: "You spent time in God's Word today!", deeplink: "https://www.bible.com/my-plans", cta: "Continue My Plans", actionFeatures: { tone: "milestone", hasPersonalization: true, ctaType: "deeplink", messageLengthBucket: "short", sourceFile: "2026-01-bioy-workflow-PUSH-14.json" } },
      { subcategory: "my-plans", name: "Take Time to Reflect (Personalized)", title: '{{${first_name} | default: ""}}, take time to reflect!', body: "What did God teach you in your whole Bible Plan today?", deeplink: "https://www.bible.com/my-plans", cta: "Continue My Plans", actionFeatures: { tone: "question", hasPersonalization: true, ctaType: "deeplink", messageLengthBucket: "short", sourceFile: "2026-01-bioy-workflow-PUSH-15.json" } },
      { subcategory: "my-plans", name: "Another Step (Personalized)", title: '{{${first_name} | default: ""}}, you took another step!', body: "You're another day closer to reading the entire Bible.", deeplink: "https://www.bible.com/my-plans", cta: "Continue My Plans", actionFeatures: { tone: "milestone", hasPersonalization: true, ctaType: "deeplink", messageLengthBucket: "short", sourceFile: "2026-01-bioy-workflow-PUSH-16.json" } },
      { subcategory: "my-plans", name: "Spent Time with God (Personalized)", title: '{{${first_name} | default: ""}}, you spent time with God!', body: "Great work being with God today.", deeplink: "https://www.bible.com/my-plans", cta: "Continue My Plans", actionFeatures: { tone: "milestone", hasPersonalization: true, ctaType: "deeplink", messageLengthBucket: "short", sourceFile: "2026-01-bioy-workflow-PUSH-17.json" } },
      { subcategory: "my-plans", name: "Small Steps Matter (Personalized)", title: '{{${first_name} | default: ""}}, small steps matter.', body: "You're one step closer to reading the entire Bible!", deeplink: "https://www.bible.com/my-plans", cta: "Continue My Plans", actionFeatures: { tone: "milestone", hasPersonalization: true, ctaType: "deeplink", messageLengthBucket: "short", sourceFile: "2026-01-bioy-workflow-PUSH-18.json" } },
      { subcategory: "my-plans", name: "Pause and Celebrate (Personalized)", title: '{{${first_name} | default: ""}}, pause and celebrate!', body: "You took another step towards reading the whole Bible today.", deeplink: "https://www.bible.com/my-plans", cta: "Continue My Plans", actionFeatures: { tone: "milestone", hasPersonalization: true, ctaType: "deeplink", messageLengthBucket: "short", sourceFile: "2026-01-bioy-workflow-PUSH-19.json" } },
      { subcategory: "my-plans", name: "God Is Guiding You (Personalized)", title: '{{${first_name} | default: ""}}, God is guiding you!', body: "You spent time with God AND took another step towards reading the whole Bible.", deeplink: "https://www.bible.com/my-plans", cta: "Continue My Plans", actionFeatures: { tone: "empathy", hasPersonalization: true, ctaType: "deeplink", messageLengthBucket: "medium", sourceFile: "2026-01-bioy-workflow-PUSH-20.json" } },
      ...
      { subcategory: "my-plans", name: "Don't Forget (Personalized)", title: '{{${first_name} | default: ""}}, don\'t forget…', body: "Continue reading your whole Bible Plan today!", deeplink: "https://www.bible.com/my-plans", cta: "Continue My Plans", actionFeatures: { tone: "urgency", hasPersonalization: true, ctaType: "deeplink", messageLengthBucket: "short", sourceFile: "2026-01-bioy-workflow-PUSH-31.json" } },
      { subcategory: "my-plans", name: "You Can Do It (Personalized)", title: '{{${first_name} | default: ""}}, you can do it!', body: "Continue reading your whole Bible Plan today.", deeplink: "https://www.bible.com/my-plans", cta: "Continue My Plans", actionFeatures: { tone: "urgency", hasPersonalization: true, ctaType: "deeplink", messageLengthBucket: "short", sourceFile: "2026-01-bioy-workflow-PUSH-32.json" } },
      { subcategory: "my-plans", name: "Keep Going (BiOY Personalized)", title: '{{${first_name} | default: ""}}, keep going!', body: "Complete another day of your whole Bible Plan.", deeplink: "https://www.bible.com/my-plans", cta: "Continue My Plans", actionFeatures: { tone: "urgency", hasPersonalization: true, ctaType: "deeplink", messageLengthBucket: "short", sourceFile: "2026-01-bioy-workflow-PUSH-33.json" } },
      { subcategory: "my-plans", name: "You've Got This (Personalized)", title: '{{${first_name} | default: ""}}, you\'ve got this!', body: "Keep going in your whole Bible Plan today.", deeplink: "https://www.bible.com/my-plans", cta: "Continue My Plans", actionFeatures: { tone: "urgency", hasPersonalization: true, ctaType: "deeplink", messageLengthBucket: "short", sourceFile: "2026-01-bioy-workflow-PUSH-34.json" } },
      { subcategory: "my-plans", name: "Got a Moment (Personalized)", title: '{{${first_name} | default: ""}}, got a moment?', body: "Continue your whole Bible Plan today.", deeplink: "https://www.bible.com/my-plans", cta: "Continue My Plans", actionFeatures: { tone: "question", hasPersonalization: true, ctaType: "deeplink", messageLengthBucket: "short", sourceFile: "2026-01-bioy-workflow-PUSH-35.json" } },
      { subcategory: "my-plans", name: "Ready to Continue (Personalized)", title: '{{${first_name} | default: ""}}, ready to continue?', body: "Return to your whole Bible Plan today.", deeplink: "https://www.bible.com/my-plans", cta: "Continue My Plans", actionFeatures: { tone: "question", hasPersonalization: true, ctaType: "deeplink", messageLengthBucket: "short", sourceFile: "2026-01-bioy-workflow-PUSH-36.json" } },
      { subcategory: "my-plans", name: "Did You Know (Personalized)", title: '{{${first_name} | default: ""}}, did you know…', body: "You can read the entire Bible! Return to your whole Bible Plan today.", deeplink: "https://www.bible.com/my-plans", cta: "Continue My Plans", actionFeatures: { tone: "question", hasPersonalization: true, ctaType: "deeplink", messageLengthBucket: "short", sourceFile: "2026-01-bioy-workflow-PUSH-37.json" } },
      { subcategory: "my-plans", name: "Spend Time with God (Personalized)", title: '{{${first_name} | default: ""}}, spend time with God!', body: "Pick up where you left off on your whole Bible Plan today.", deeplink: "https://www.bible.com/my-plans", cta: "Continue My Plans", actionFeatures: { tone: "urgency", hasPersonalization: true, ctaType: "deeplink", messageLengthBucket: "short", sourceFile: "2026-01-bioy-workflow-PUSH-38.json" } },
      { subcategory: "my-plans", name: "Open Your Bible (Personalized)", title: '{{${first_name} | default: ""}}, open your Bible.', body: "Continue reading your whole Bible Plan today!", deeplink: "https://www.bible.com/my-plans", cta: "Continue My Plans", actionFeatures: { tone: "urgency", hasPersonalization: true, ctaType: "deeplink", messageLengthBucket: "short", sourceFile: "2026-01-bioy-workflow-PUSH-39.json" } },
      { subcategory: "my-plans", name: "Need Encouragement (Personalized)", title: '{{${first_name} | default: ""}}, need encouragement?', body: "Continue reading your whole Bible Plan today!", deeplink: "https://www.bible.com/my-plans", cta: "Continue My Plans", actionFeatures: { tone: "empathy", hasPersonalization: true, ctaType: "deeplink", messageLengthBucket: "short", sourceFile: "2026-01-bioy-workflow-PUSH-40.json" } },
  ...
  // ── VOTD ───────────────────────────────────────────────────────────────────
  {
    ...
    variants: [
      ...
      { subcategory: "votd-page", name: "God's Word Can Change a Life (Remind)", title: "God's Word can change a life.", body: "Read this verse and let God's Word transform you today.", deeplink: "https://www.bible.com/verse-of-the-day", cta: "See Verse of the Day", actionFeatures: { tone: "empathy", hasPersonalization: false, ctaType: "deeplink", messageLengthBucket: "short", sourceFile: "2026-01-daily-remind-PUSH-10-en.json" } },
      { subcategory: "votd-page", name: "Don't Miss This (Remind)", title: "Don't miss this!", body: "Spend time with God and read the Verse of the Day.", deeplink: "https://www.bible.com/verse-of-the-day", cta: "See Verse of the Day", actionFeatures: { tone: "urgency", hasPersonalization: false, ctaType: "deeplink", messageLengthBucket: "short", sourceFile: "2026-01-daily-remind-PUSH-11-en.json" } },
      { subcategory: "votd-page", name: "Don't Miss This (Personalized Remind)", title: '{{${first_name} | default: ""}}, don\'t miss this!', body: "Spend time with God and read the Verse of the Day.", deeplink: "https://www.bible.com/verse-of-the-day", cta: "See Verse of the Day", actionFeatures: { tone: "urgency", hasPersonalization: true, ctaType: "deeplink", messageLengthBucket: "short", sourceFile: "2026-01-daily-remind-PUSH-11-en.json" } },
      { subcategory: "votd-page", name: "God Cares for You (Remind)", title: "God cares for you.", body: "Reflect on the Verse of the Day today.", deeplink: "https://www.bible.com/verse-of-the-day", cta: "See Verse of the Day", actionFeatures: { tone: "empathy", hasPersonalization: false, ctaType: "deeplink", messageLengthBucket: "short", sourceFile: "2026-01-daily-remind-PUSH-13-en.json" } },
      { subcategory: "votd-page", name: "God Cares for You (Personalized Remind)", title: '{{${first_name} | default: ""}}, God cares for you.', body: "Reflect on the Verse of the Day today.", deeplink: "https://www.bible.com/verse-of-the-day", cta: "See Verse of the Day", actionFeatures: { tone: "empathy", hasPersonalization: true, ctaType: "deeplink", messageLengthBucket: "short", sourceFile: "2026-01-daily-remind-PUSH-13-en.json" } },
      // votd-page — 2026 Resurrection Push (daily rotating verse teaser → VOTD page)
      { subcategory: "votd-page", name: "Never Give Up (Resurrection)", title: "✊ Never give up!", body: "Though outwardly we are wasting away, yet inwardly we are being renewed day by day.", deeplink: "https://www.bible.com/verse-of-the-day", cta: "See Verse of the Day", actionFeatures: { tone: "urgency", hasPersonalization: false, ctaType: "deeplink", messageLengthBucket: "medium", sourceFile: "2026-Q1-resurrection-Bmessage-en.yml" } },
      { subcategory: "votd-page", name: "Be Strong and Courageous (Resurrection)", title: "💪 Be strong and courageous! 🛡 God is with you…", body: "Do not be afraid; do not be discouraged, for the Lord your God will be with you wherever you go.", deeplink: "https://www.bible.com/verse-of-the-day", cta: "See Verse of the Day", actionFeatures: { tone: "urgency", hasPersonalization: false, ctaType: "deeplink", messageLengthBucket: "medium", sourceFile: "2026-Q1-resurrection-Bmessage-en.yml" } },
      { subcategory: "votd-page", name: "Delight in the Lord (Resurrection)", title: "🤗 Delight yourself in the Lord…", body: "Take delight in the Lord, and he will give you the desires of your heart.", deeplink: "https://www.bible.com/verse-of-the-day", cta: "See Verse of the Day", actionFeatures: { tone: "empathy", hasPersonalization: false, ctaType: "deeplink", messageLengthBucket: "short", sourceFile: "2026-Q1-resurrection-Bmessage-en.yml" } },
      { subcategory: "votd-page", name: "Don't Worry About Anything (Resurrection)", title: "🙏 \"Don't worry about anything; instead…\"", body: "Don't worry about anything; instead, pray about everything. Tell God what you need, and thank him for all he has done.", deeplink: "https://www.bible.com/verse-of-the-day", cta: "See Verse of the Day", actionFeatures: { tone: "empathy", hasPersonalization: false, ctaType: "deeplink", messageLengthBucket: "long", sourceFile: "2026-Q1-resurrection-Bmessage-en.yml" } },
      { subcategory: "votd-page", name: "I Can Do All Things (Resurrection)", title: "💪 We can do more because God gives us strength…", body: "I can do all this through him who gives me strength.", deeplink: "https://www.bible.com/verse-of-the-day", cta: "See Verse of the Day", actionFeatures: { tone: "urgency", hasPersonalization: false, ctaType: "deeplink", messageLengthBucket: "short", sourceFile: "2026-Q1-resurrection-Bmessage-en.yml" } },
      { subcategory: "votd-page", name: "I Am the Way (Resurrection)", title: "🛣 \"I am the way, …the truth, and the life…\"", body: "Jesus answered, I am the way and the truth and the life. No one comes to the Father except through me.", deeplink: "https://www.bible.com/verse-of-the-day", cta: "See Verse of the Day", actionFeatures: { tone: "empathy", hasPersonalization: false, ctaType: "deeplink", messageLengthBucket: "medium", sourceFile: "2026-Q1-resurrection-Bmessage-en.yml" } },
      { subcategory: "votd-page", name: "Seek Me with All Your Heart (Resurrection)", title: "🔍 …look for me whole ❤️…you will find me…", body: "You will seek me and find me when you seek me with all your heart.", deeplink: "https://www.bible.com/verse-of-the-day", cta: "See Verse of the Day", actionFeatures: { tone: "urgency", hasPersonalization: false, ctaType: "deeplink", messageLengthBucket: "short", sourceFile: "2026-Q1-resurrection-Bmessage-en.yml" } },
